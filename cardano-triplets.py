...
class primeData():
    def __init__(self, bound):
        ...
        self.primes = []
        self.breakDown(bound)
    
    def breakDown(self, bound):
        ...
        for i in range(2, bound + 1):
            ...
            if i == 2 or 8 * bound + 5 < i**2:
                continue
            k = (-5 * self._inverse_change(8, i**2)) % i**2
            if k > bound:
                continue
            ...
            d = i**4
            while d <= bound:
                k = (-5 * self._inverse_change(8, d)) % d
    ...
    def _inverse_change(self, a, mod):
...
class Factorization():
    def __init__(self, bound):
        self.prime_table = primeData(bound)
